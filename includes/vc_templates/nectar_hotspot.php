...
echo '<div class="nectar_hotspot_wrap" style="top: '.esc_attr($top).'; left: '.esc_attr($left).';"><div class="nectar_hotspot '.$click_class.'"><span>'.$hotspot_icon.'</span></div><div class="nttip '.$tooltip_content_class.'" data-tooltip-position="'.esc_attr($position).'"><div class="inner">'.wp_kses_post($content).'</div></div></div>';

...
if(!function_exists('nectar_post_grid_item_markup')) {
  ...
  function nectar_post_grid_item_markup($atts, $index = 0, $type = 'regular') {
      ...
      if( $post ) {
          ...
          // TWW+
          $tww_plus = '';
          if(has_term('tww+', 'post_tag', $post->ID)) {
            $tww_plus .= '<span class="meta-tww-plus"><img class="tww-plus-logo-dark salient-core-tww-plus" src="'. SALIENT_CORE_PLUGIN_PATH . '/images/TWWPLus_logo_bold-dark.svg" /></span>';
          }
